...
International comparisons are instructive. Northern European countries, particularly Sweden, Denmark, and Germany, operate WtE fleets with substantially higher average energy recovery efficiencies than Japan, attributable to a combination of larger average facility size, district heating integration that allows recovery of both electricity and heat, and more recent construction vintage \citep{Munster2010}. Japan's lack of district heating networks, a consequence of its different urban form and climate patterns in major population centers, means that only electrical efficiency is typically considered, understating the potential thermal recovery value but also limiting the realistic efficiency ceiling.
...
Municipal mergers (\emph{heisei no daigappei}, the wave of municipal consolidations that reduced Japan's municipality count from approximately 3,200 to 1,700 between 1999 and 2010 \citep{Rausch2006}) create particular challenges because facilities may be reported under different administrative units before and after merger without any change in physical characteristics. These cases were identified and corrected manually where possible.
...
where $i$ indexes facilities, $t$ indexes fiscal years, $\gamma_t$ is a year fixed effect capturing common shocks (e.g., the Fukushima event, changes in the feed-in tariff), and $\epsilon_{it}$ is the idiosyncratic error term. The key parameters of interest are $\beta_1$ through $\beta_3$, corresponding to age, scale, and utilization.
...
\begin{table}[H]
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lrrrr@{}}
    ...
    $R^2$ (within)           & 0.186            & 0.203            & n/a              & n/a              \\
    $R^2$ (between)          & 0.574            & 0.561            & n/a              & n/a              \\
    $R^2$ (overall)          & 0.412            & 0.419            & 0.408            & 0.416            \\
    \bottomrule
  \end{tabular*}
  \smallskip
...
\bibitem[van Beukering et al.(1999)]{vanBeukering1999}
van Beukering, P., Sehker, M., Gerlagh, R., \& Kumar, V. (1999).
\emph{Analysing urban solid waste in developing countries: A perspective on Bangalore, India}.
CREED Working Paper No.~24.
Retrieved from \url{https://www.iied.org/8113iied}
