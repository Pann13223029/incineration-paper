...
This trajectory intersects with two major structural shocks. The first is the 2011 Fukushima Daiichi nuclear disaster, which caused Japan to shut down virtually all of its nuclear generating capacity and scrambled national energy markets. In this context, distributed power sources — including waste-to-energy — gained renewed policy attention as Japan sought to replace lost baseload capacity with a diversified portfolio [@SasakawaPF2012]. The second is the Paris Agreement commitments of 2015 and Japan's subsequent Green Growth Strategy, which set the 2050 carbon neutrality target and prompted systematic review of emission sources across all sectors, including waste.
