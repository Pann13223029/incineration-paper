...
| Item | Status |
|:-----|:-------|
| Authoritative thesis source | `legacy/thesis/thesis.tex` |
| Canonical analysis rebuild | `.venv/bin/python code/analysis/07_rebuild_analysis.py` |
| Repo-level claim/evidence verifier | `.venv/bin/python code/analysis/08_verify_claims.py` |
...
- Thesis source: `legacy/thesis/thesis.tex`
- Technical blueprint: `ARCHITECTURE.md`
- Repo summary and reproduction guide: `README.md`
- Examiner risk register: `legacy/research/notes/examiner-risk-register.md`
- Claim verification report: `output/claim_verification.md`
