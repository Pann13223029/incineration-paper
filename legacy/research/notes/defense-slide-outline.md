...
- Reuse the fleet split graphic from [readme_fleet_split.svg](../../../docs/figures/readme_fleet_split.svg) or a simplified version
...
- Compact hazard table from [adoption_results.md](../../../output/adoption_results.md)
...
- One stacked bar or multi-category bar chart using [adoption_pathway_audit.csv](../../../output/adoption_pathway_audit.csv)
...
- Two-column “claims / non-claims” mini table pulled from [what-this-thesis-does-not-claim.md](what-this-thesis-does-not-claim.md)
