...
2. Start with `legacy/research/notes/final-viva-cheat-sheet.md` for the one-file viva spine.
3. Rehearse using `legacy/research/notes/defense-question-order.md`.
4. Use `legacy/research/notes/defense-rapid-answers.md` for fast-answer rehearsal.
5. Use `legacy/research/notes/defense-q-and-a.md` for hostile follow-up preparation.
6. Use `legacy/research/notes/defense-run-sheet.md` for timed delivery.
...
- `legacy/research/slides/dist/defense-deck.html`
...
- `legacy/research/slides/dist/defense-deck.pdf` when a local Chrome/Edge browser can launch headlessly
...
- `legacy/research/slides/dist/defense-bundle/`
- `legacy/research/slides/dist/defense-bundle.zip`
