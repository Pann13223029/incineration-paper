...
CHECKPOINTS_ROOT = REPO_ROOT / "legacy" / "research" / "checkpoints"
DIST_ROOT = REPO_ROOT / "legacy" / "research" / "checkpoints" / "dist"
...
def ensure_packets() -> None:
    subprocess.run([sys.executable, "legacy/scripts/11_package_review_packets.py"], cwd=REPO_ROOT, check=True)
