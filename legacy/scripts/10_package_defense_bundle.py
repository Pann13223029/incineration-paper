...
DIST_ROOT = REPO_ROOT / "legacy" / "research" / "slides" / "dist"
BUNDLE_ROOT = DIST_ROOT / "defense-bundle"
ZIP_PATH = DIST_ROOT / "defense-bundle.zip"

FILES_TO_COPY: list[tuple[str, str | None]] = [
    ("legacy/research/slides/defense-deck.md", None),
    ("legacy/research/slides/dist/defense-deck.html", "legacy/research/slides/defense-deck.html"),
    ("legacy/research/slides/themes/defense-apu.css", None),
    ("legacy/research/notes/final-viva-cheat-sheet.md", None),
    ("legacy/research/notes/defense-rapid-answers.md", None),
    ("legacy/research/notes/defense-run-sheet.md", None),
    ("legacy/research/notes/defense-question-order.md", None),
    ("legacy/research/notes/defense-q-and-a.md", None),
...
DIRS_TO_COPY = [
    "legacy/research/slides/figures",
    "docs/figures",
]
...
def run_slide_export() -> None:
    subprocess.run(
        ["python3", "legacy/scripts/09_export_defense_slides.py"],
        cwd=REPO_ROOT,
        check=True,
    )
...
1. Open `legacy/research/slides/defense-deck.html` in a browser for the presentation view.
2. Use `legacy/research/notes/final-viva-cheat-sheet.md` as the main oral-defense rehearsal sheet.
3. Use `legacy/research/notes/defense-run-sheet.md` for timed delivery.
4. Use `legacy/research/notes/defense-rapid-answers.md` for short-answer rehearsal.
5. Use `legacy/research/notes/defense-q-and-a.md` for hostile follow-up practice.
6. Use `output/claim_verification.md` to confirm the thesis-facing evidence spine.

## Included artifacts

- HTML deck: `legacy/research/slides/defense-deck.html`
- Slide source: `legacy/research/slides/defense-deck.md`
- Slide figures and theme: `legacy/research/slides/figures/`, `legacy/research/slides/themes/`
- Rehearsal notes: `legacy/research/notes/`
- Main viva cheat sheet: `legacy/research/notes/final-viva-cheat-sheet.md`
