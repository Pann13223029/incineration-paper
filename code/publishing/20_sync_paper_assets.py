...
SOURCE_FILES = [
    ...
    "fleet_turnover_decomposition.md",
    "fleet_turnover_decomposition.csv",
    ...
    "entry_standardized_risk.csv",
    "entry_capacity_support.csv",
    "entry_design_diagnostics.csv",
    "entry_specification_summary.csv",
    "entry_sample_flow.csv",
    "entry_state_audit.csv",
    "adoption_event_composition.csv",
    "raw_quantity_component_results.csv",
    "common_control_component_decomposition.csv",
