# Selected References For The Integrated Paper

This is the working reference set for the current one-paper strategy. It is not
the full thesis bibliography. It is the smaller set that directly supports the
paper's framing, methods, and interpretation.

## Sector And System Context
...
- Rausch, A. (2006). The Heisei Dai Gappei: A case study for understanding the municipal mergers of the Heisei era. *Japan Forum*, *18*(1), 133-156. https://doi.org/10.1080/09555800500498558
- Sakai, S., Ikematsu, T., Hirai, Y., & Yoshida, H. (2008). Unit-charging programs for municipal solid waste in Japan. *Waste Management*, *28*(12), 2815-2825. https://doi.org/10.1016/j.wasman.2008.07.010
- Seto, K. C., Davis, S. J., Mitchell, R. B., Stokes, E. C., Unruh, G., & Urge-Vorsatz, D. (2016). Carbon lock-in: Types, causes, and policy implications. *Annual Review of Environment and Resources*, *41*(1), 425-452. https://doi.org/10.1146/annurev-environ-110615-085934
...
If a source is not serving the current article's framing, methods, or
interpretation directly, keep it out of the main paper and leave it in the
thesis-only bibliography.
