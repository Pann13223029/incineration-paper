...
This note sets working constraints for the first full article draft.
...
1. framework figure on page 1 or 2
2. adoption results figure
3. optional efficiency-structure figure if it clearly adds explanatory value

Default rule:

- aim for 2 required figures
- allow a 3rd only if it carries argument better than prose plus table

## Table Budget

Main text:

1. one compact descriptive table
2. one adoption results table
3. one efficiency results table
