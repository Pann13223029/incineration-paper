...
- [shared panel construction](../../code/scripts/panel_utils.py)
- [entry estimator implementation](../../code/scripts/05a_power_adoption.py)
- [generator estimator implementation](../../code/scripts/05_panel_regression.py)
