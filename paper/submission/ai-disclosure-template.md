...
Revise the named tools and purposes if the workflow changes. Do not remove code
assistance from the disclosure while AI-assisted code remains in the analysis
history.
